...
namespace QuanLyThuVien.Controllers
{
    public class TaiKhoanController : Controller
    {
        ...
        {
            if (db.TaiKhoans.Find(taiKhoan.TaiKhoan1) != null)
            {
                taiKhoan.ErMes = "Tài khoản không hợp lệ";
            ...
            if (db.NhanViens.Find(taiKhoan.MaNV) == null)
            {
                taiKhoan.ErMes = "Mã nhân viên không hợp lệ";
                ViewBag.LoaiTK = new SelectList(db.LoaiTKs, "id", "name", taiKhoan.LoaiTK);
                ViewBag.MaNV = new SelectList(db.NhanViens, "MaNV", "Chucvu", taiKhoan.MaNV);
                return View(taiKhoan);
            }
